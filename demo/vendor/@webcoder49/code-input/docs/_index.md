...
# An <mark>editable</mark> `<textarea>` that supports _any_ <mark>syntax highlighting</mark> algorithm, for code or something else. [Also, added plugins.](plugins)
