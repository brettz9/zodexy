...
codeInput.plugins.Autocomplete = class extends codeInput.Plugin {
  ...
  updatePopup(codeInput, onlyScrolled) {
    ...
    let caretCoords = this.getCaretCoordinates(
      codeInput,
      textarea,
  ...
  afterElementsAdded(codeInput) {
    ...
    textarea.addEventListener("input", () => {
      this.updatePopup(codeInput, false);
    });
  ...
  getCaretCoordinates(codeInput, textarea, charIndex, onlyScrolled) {
    ...
    if (onlyScrolled) {
      ...
      let spans = codeInput
        .querySelector(".code-input_autocomplete_testpos")
      ...
      let testPosElem = codeInput.querySelector(
        ".code-input_autocomplete_testpos",
      );
    ...
    return {
      top: afterSpan.offsetTop - textarea.scrollTop,
      left: afterSpan.offsetLeft - textarea.scrollLeft,
    };
  }
