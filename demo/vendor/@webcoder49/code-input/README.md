...
> **An editable &lt;textarea&gt; that supports _any_ syntax highlighting algorithm, for code or something else. Also, added plugins.**
>
...
_This demonstration uses themes from [Prism.js](https://prismjs.com/) and [highlight.js](https://highlightjs.org/), two syntax-highlighting programs which work well with and have compatibility built-in with code-input._
