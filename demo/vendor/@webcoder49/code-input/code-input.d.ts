...
export namespace plugins {
  ...
  class SelectTokenCallbacks extends Plugin {
     ...
     */
    constructor(
      tokenSelectorCallbacks?: codeInput.plugins.SelectTokenCallbacks.TokenSelectorCallbacks,
      onlyCaretNotSelection?: boolean,
      caretAtStartIsSelected?: boolean,
      caretAtEndIsSelected?: boolean,
      createSubTokens?: boolean,
      partiallySelectedTokensAreSelected?: boolean,
      parentTokensAreSelected?: boolean,
    );
  }
  ...
  namespace SelectTokenCallbacks {
    ...
    class TokenSelectorCallbacks {
       ...
       */
      constructor(
        tokenSelectedCallback: (token: HTMLElement) => void,
        selectChangedCallback: (tokenContainer: HTMLElement) => void,
      );
      ...
      ): codeInput.plugins.SelectTokenCallbacks.TokenSelectorCallbacks;
    }
  }
  ...
  class SpecialChars extends Plugin {
     ...
     */
    constructor(
      colorInSpecialChars?: boolean,
      inheritTextColor?: boolean,
      specialCharRegExp?: RegExp,
    );
  }
...
export class Template {
   ...
   */
  constructor(
    highlight?: (codeElement: HTMLElement, codeInput: CodeInput) => void,
    preElementStyled?: boolean,
    isCode?: boolean,
 ...
 */
export class CodeInput extends HTMLTextAreaElement {
  // Tries to implement textarea interface
  /**
   ...
   */
  setKeyboardNavInstructions(
    instructions: string,
    includeAriaDescriptionFirst: boolean,
  ): void;
  /**
